      ...
      <div className="Place__choice">
        ...
        <div className="Place__choice-item">
          ...
          <Checkbox 
            ...
            onToggle={() => {
              if (faster) {
                setStorageItem('faster', false);
                setFaster(false);
              } else {
                setStorageItem('time', '');
                setTime(getStorageItem('time'));
                setStorageItem('faster', true);
                setFaster(true);
              }
            }}
          />
        ...
        <div className="Place__choice-item">
          ...
          <input
            ...
            onChange={event => {
              setStorageItem('faster', false);
              setFaster(false);
              setStorageItem('time', event.target.value);
              setTime(getStorageItem('time'));
            }}
            onBlur={() => {
              if (time) {
        ...
        <div className="Place__choice-item">
          ...
          <Checkbox checked={selfService} onToggle={() => {
            const tag = 'selfService';
            const itm = getStorageItem(tag);
            setSelfService(itm);
            setStorageItem(tag, !selfService);
          }
          } />
        </div>
        <div className="Place__choice-item">
